...
const file_app_dns_config_proto_rawDesc = "" +
	"\n" +
	"\x14app/dns/config.proto\x12\fxray.app.dns\x1a\x1ccommon/net/destination.proto\x1a\x17app/router/config.proto\"\x92\x05\n" +
	"\n" +
	"NameServer\x123\n" +
	...
	"\x05geoip\x18\x03 \x03(\v2\x16.xray.app.router.GeoIPR\x05geoip\x12L\n" +
	"\x0eoriginal_rules\x18\x04 \x03(\v2%.xray.app.dns.NameServer.OriginalRuleR\roriginalRules\x12B\n" +
	"\x0equery_strategy\x18\a \x01(\x0e2\x1b.xray.app.dns.QueryStrategyR\rqueryStrategy\x12.\n" +
	"\x12allowUnexpectedIPs\x18\b \x01(\bR\x12allowUnexpectedIPs\x12\x10\n" +
	"\x03tag\x18\t \x01(\tR\x03tag\x12\x1c\n" +
	"\ttimeoutMs\x18\n" +
	" \x01(\x04R\ttimeoutMs\x1a^\n" +
