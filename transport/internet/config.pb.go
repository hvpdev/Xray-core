...
const file_transport_internet_config_proto_rawDesc = "" +
	...
	"\x13transportLayerProxy\x18\x02 \x01(\bR\x13transportLayerProxy\"{\n" +
	"\rCustomSockopt\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x14\n" +
	"\x05level\x18\x02 \x01(\tR\x05level\x12\x10\n" +
	"\x03opt\x18\x03 \x01(\tR\x03opt\x12\x14\n" +
	"\x05value\x18\x04 \x01(\tR\x05value\x12\x12\n" +
	"\x04type\x18\x05 \x01(\tR\x04type\"\xfd\a\n" +
	...
	"\x15address_port_strategy\x18\x15 \x01(\x0e2,.xray.transport.internet.AddressPortStrategyR\x13addressPortStrategy\"/\n" +
	"\n" +
	"TProxyMode\x12\a\n" +
	"\x03Off\x10\x00\x12\n" +
	"\n" +
	"\x06TProxy\x10\x01\x12\f\n" +
	"\bRedirect\x10\x02*\xa9\x01\n" +
